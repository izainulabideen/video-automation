...
function heroConfig(style:string, accent:string, accentH:string, bg:string, name:string, tagline:string) {
  switch(style) {
    case 'horror': return {
      ...
      hl2Style: { display:'inline-block', background:`linear-gradient(180deg,${accent} 0%,#400000 100%)`, WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text', letterSpacing:'-0.05em' },
    ...
    case 'epic': return {
      ...
      hl2Style: { display:'inline-block', background:`linear-gradient(135deg,${accentH} 0%,${accent} 60%)`, WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text', letterSpacing:'-0.03em', fontWeight:900 },
    ...
    case 'mystical': return {
      ...
      hl2Style: { display:'inline-block', background:`linear-gradient(135deg,#fff 0%,${accentH} 50%,${accent}88 100%)`, WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text', letterSpacing:'-0.02em', fontWeight:900 },
    ...
    case 'warm': return {
      ...
      hl2Style: { display:'inline-block', background:`linear-gradient(135deg,${accentH} 0%,${accent} 100%)`, WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text', letterSpacing:'-0.04em', fontWeight:900 },
    ...
    default: return {
      ...
      hl1Style: { color:'#fff' },
      hl2Style: { display:'inline-block', background:`linear-gradient(135deg,${accentH} 0%,${accent} 40%,${accent}88 100%)`, WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' },
